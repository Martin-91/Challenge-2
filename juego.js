...
const palabras = [
 "JUEGO", "JUGAR", "PERDER", "LEON", "TIGRE", "LORENZO", "LORO", "PERDER", "GANAR", "AMIGO", "AMISTAD","NOVIO", "NOVIA", "ESPOSA", "AMANTE", "ABACO", "ABANICO", "PLANCHA", "MESA", "PUERTA", "TESORO", "PIRATA","PELICULA","DIARIO","AFRICA","BACALAO","TORTUGA","ALFILER","AGUJA","TRACTOR","PERDON","CASTIGO","COMIDA", "AVION", "ANIMAL", "ELEFANTE", "MUNDO", "PLANETA", "BOXEO",  
];
const btn = id('jugar');
